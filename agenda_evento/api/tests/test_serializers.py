...
def test_deve_serializar_evento(evento_factory):  # objeto > json
...
def test_deve_desserializar_evento():  # json > objeto
    ...
    assert evento_desserializado.convidados == ['israel.tst@tst.com', 'israel.tst2@tst.com']
