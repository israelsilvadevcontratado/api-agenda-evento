...
def test_deve_listar_eventos(client: Client, evento_factory):
    ...
    assert dados_response['convidados'] == ['israel.tst@tst.com', 'israel.tst2@tst.com']
...
def test_deve_listar_evento_por_id(client: Client, corpo_requisicao):
    ...
    assert response.data['convidados'] == ['israel@tst.com']
...
def test_deve_editar_evento(client: Client, corpo_requisicao):
    ...
    assert response.data['convidados'] == ['israel@tst2.com']
