...
def test_deve_criar_evento(client: Client):
    dados_requisicao = {
        ...
        'horario_fim': '17:08',
        'convidados': ['israel.silva@desenvolvedorcontratado.com.br'],
...
def test_deve_listar_eventos(client: Client):
